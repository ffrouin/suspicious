...
my $hist_dir = '/path/to/your/frontend/root/dir/db';
...
print "host,ip,service,occurences,country,region,city,lat,lon,timelog\n";
...
sub get_geodata {
   ...
   my @raw = split(',',`/usr/bin/geoiplookup -f /usr/share/GeoIP/GeoLiteCity.dat $ip`);
